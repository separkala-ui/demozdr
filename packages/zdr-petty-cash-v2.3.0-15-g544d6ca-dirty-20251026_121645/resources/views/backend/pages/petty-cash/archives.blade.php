        ...
        <div class="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <form method="get" class="mt-6 grid grid-cols-1 gap-4 lg:grid-cols-4">
                ...
                <div>
                    ...
                    <input type="text" name="date_from" value="{{ $filters['date_from'] }}" class="mt-1 block w-full rounded-md border-slate-300 px-3 py-2 text-sm shadow focus:border-indigo-500 focus:ring-indigo-500 jalali-date-input" placeholder="{{ __('مثال: 1404/07/27') }}" x-data x-init="window.initJalaliDatepicker($el, { enableTime: false })">
                </div>
                <div>
                    <label class="text-xs font-semibold text-slate-500">{{ __('تا تاریخ') }}</label>
                    <input type="text" name="date_to" value="{{ $filters['date_to'] }}" class="mt-1 block w-full rounded-md border-slate-300 px-3 py-2 text-sm shadow focus:border-indigo-500 focus:ring-indigo-500 jalali-date-input" placeholder="{{ __('مثال: 1404/08/01') }}" x-data x-init="window.initJalaliDatepicker($el, { enableTime: false })">
                </div>

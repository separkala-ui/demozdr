...
<div class="container mx-auto p-6 max-w-2xl">
    ...
    <form action="{{ route('admin.inspection.store') }}" method="POST" class="bg-white rounded-lg shadow p-6 space-y-6">
        @csrf
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('admin.inspection.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-6 py-2 rounded-lg">
                {{ __('لغو') }}
            </a>
        </div>
    </form>

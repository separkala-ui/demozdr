    ...
    <div class="relative p-4 w-full max-w-md">
        ...
        <div class="relative bg-white rounded-md shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-md text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="add-language-modal">
            ...
            <div class="p-6 space-y-6">
                <form action="{{ route('admin.translations.create') }}" method="POST" id="add-language-form">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="language-code" name="language_code" class="h-11 w-full rounded-md border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90" required>
                    ...
                    <div class="mb-4">
                        ...
                        <select id="translation-group" name="group" class="h-11 w-full rounded-md border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90" required>

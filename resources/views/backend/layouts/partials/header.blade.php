    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            ...
            <button
                ...
                class="z-99999 flex h-10 w-10 items-center justify-center rounded-md border-gray-200 text-gray-500 lg:h-11 lg:w-11 lg:border dark:border-gray-800 dark:text-gray-400 transition-all duration-300"
...
{{--                        <img src="{{ asset('images/icons/github.svg') }}" alt="GitHub" class="dark:invert" />--}}
                        <iconify-icon icon="lucide:github" width="24" height="24"

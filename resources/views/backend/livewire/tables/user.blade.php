                        ...
                        <div x-show="open" @click.outside="open = false" x-transition
                            ...
                            <ul class="space-y-2">
                                <li class="cursor-pointer text-sm text-gray-700 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-600 px-2 py-1.5 rounded"
                                    wire:click="$set('role', '')" @click="open = false">
                                    {{ __('All Roles') }}
                                </li>
                                @foreach ($roles as $id => $name)
                                    <li class="cursor-pointer text-sm text-gray-700 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-600 px-2 py-1.5 rounded {{ $role === $name ? 'bg-gray-200 dark:bg-gray-600' : '' }}"
                                        wire:click="$set('role', '{{ $name }}')" @click="open = false">
                                        {{ ucfirst($name) }}
                                    </li>
                                @endforeach
                            </ul>
                    ...
                    <thead class="table-thead">
                        <tr class="table-tr">
                            ...
                            <th width="20%" class="table-thead-th">
                                <div class="flex items-center">
                                    {{ __('Name') }}
                                    <button wire:click="sortBy('first_name')" class="ml-1 focus:outline-none">
                                        @if($sort === 'first_name' && $direction === 'asc')
                                            <iconify-icon icon="lucide:sort-asc" class="text-primary"></iconify-icon>
                                        @elseif($sort === 'first_name' && $direction === 'desc')
                            ...
                            <th width="10%" class="table-thead-th">
                                <div class="flex items-center">
                                    {{ __('Email') }}
                                    <button wire:click="sortBy('email')" class="ml-1 focus:outline-none">
